...
real32_T rt_modf_snf(real32_T u0, real32_T u1)
{
  ...
  if (u1 == 0.0F) {
    ...
    yEq = (y == 0.0F);
    if (!yEq && (u1 > (real32_T)floor((real_T)u1))) {
      q = (real32_T)fabs((real_T)((real32_T)(u0 / u1)));
      yEq = !((real32_T)fabs((real_T)((real32_T)(q - (real32_T)floor((real_T)
                  ((real32_T)(q + 0.5F)))))) > (FLT_EPSILON * q));
    }
