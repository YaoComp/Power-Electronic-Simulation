 ...
 *    'PI Controller1' ('Off_Grid_Inverter_Control_LC:2608')
 */
void PI_Controller(real32_T rtu_Error, boolean_T rtu_Reset, real32_T *rty_Out,
                   real32_T rtp_Kp, real32_T rtp_Ts, real32_T rtp_Max, real32_T
                   rtp_Min, real32_T rtp_Ki, DW_PI_Controller_T *localDW,
                   ZCE_PI_Controller_T *localZCE)
{
  real32_T rtb_Add2;
  real32_T rtb_Delay;
