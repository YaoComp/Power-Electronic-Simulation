...
COMPILER_COMMAND_FILE     = PQ_Control_LCL_comp.rsp
CMD_FILE                  = PQ_Control_LCL.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/PQ_Control_LCL.exe
...
DEFINES_STANDARD = -DMODEL=PQ_Control_LCL -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/PQ_Control_LCL_ert_rtw/PQ_Control_LCL.c $(START_DIR)/PQ_Control_LCL_ert_rtw/PQ_Control_LCL_data.c

MAIN_SRC = $(START_DIR)/PQ_Control_LCL_ert_rtw/ert_main.c
...
OBJS = PQ_Control_LCL.obj PQ_Control_LCL_data.obj
...
%.obj : $(START_DIR)/PQ_Control_LCL_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/PQ_Control_LCL_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/PQ_Control_LCL_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/PQ_Control_LCL_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/PQ_Control_LCL_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
PQ_Control_LCL.obj : $(START_DIR)/PQ_Control_LCL_ert_rtw/PQ_Control_LCL.c
	$(CC) $(CFLAGS) -o "$@" "$<"


PQ_Control_LCL_data.obj : $(START_DIR)/PQ_Control_LCL_ert_rtw/PQ_Control_LCL_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.obj : $(START_DIR)/PQ_Control_LCL_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
